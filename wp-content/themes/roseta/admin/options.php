...
'options' => array (
	...
	'id' => 'theme_menustyle',
		'type' => 'select',
		'values' => array( 0, 1 ),
		'labels' => array( __("Disabled","roseta"), __("Enabled","roseta") ),
	...
	'id' => 'theme_headerheight',
		...
		'min' => 0,
		'max' => 800,
		'label' => __('Header Image Height (in pixels)','roseta'),
		'desc' => '',
	'section' => 'theme_headercontent' ),
	array(
	...
	'id' => 'theme_lpboxheight#',
		...
		'desc' => __("In pixels. The width is a percentage dependent on total site width and number of columns per row.","roseta"),
		'priority' => 60,
	'section' => 'theme_lpboxes#' ),
	array(
	...
	'id' => 'theme_lpblocksbg',
		'type' => 'color',
		'label' => __('Blocks Background','roseta'),
		'desc' => '',
	'section' => 'theme_colors_lp' ),
	array(
	'id' => 'theme_lpboxesbg',
		'type' => 'color',
		'label' => __('Boxes Background','roseta'),
		'desc' => '',
	'section' => 'theme_colors_lp' ),
	array(
	'id' => 'theme_lptextsbg',
		'type' => 'color',
		'label' => __('Text Areas Background','roseta'),
		'desc' => '',
	'section' => 'theme_colors_lp' ),
	array(
	'id' => 'theme_lppostsbg',
		'type' => 'color',
		'label' => __('Featured Content Background','roseta'),
		'desc' => '',
	'section' => 'theme_colors_lp' ),
	array(
	'id' => 'theme_accent1',
	...
	'id' => 'theme_fgeneralgoogle',
		...
		'input_attrs' => array( 'placeholder' => __('or enter Google Font Identifier','roseta') ),
	'section' => 'theme_fontfamily' ),
	...
	array( // header titles title
	'id' => 'theme_fht_titlesize',
		'type' => 'select',
		'label' => __('Header Titles Title','roseta'),
		'values' => cryout_gen_values( 140, 300, 5, array('um'=>'%') ),
		'desc' => '',
	'section' => 'theme_fontheader' ),
	array(
	...
	'id' => 'theme_paragraphspace',
		'type' => 'select',
		'label' => __('Paragraph Spacing','roseta'),
	...
	'id' => 'theme_breadcrumbs',
		...
		'values' => array( 1, 0 ),
		'labels' => array( __("Enable","roseta"), __("Disable","roseta") ),
		'desc' => '',
...
array(
	...
	'id' => 'theme_comformwidth',
		'type' => 'number',
		'label' => __('Comment Form Width (pixels)','roseta'),
		'desc' => '',
	'section' => 'theme_comments' ),
	...
	'id' => 'theme_fpost',
		...
		'values' => array( 1, 0 ),
		'labels' => array( __("Enabled","roseta"), __("Disabled","roseta") ),
		'desc' => '',
	...
	'id' => 'theme_fheight',
		'type' => 'number',
		'label' => __( 'Featured Image Height (in pixels)', 'roseta' ),
