...
html
					{ font-family: <?php echo cryout_font_select( $theme_fgeneral, $theme_fgeneralgoogle ) ?>;
					  font-size: <?php echo esc_html( $theme_fgeneralsize ) ?>; font-weight: <?php echo esc_html( $theme_fgeneralweight ) ?>;
...
#site-title 		{ font-family: <?php echo cryout_font_select( $theme_fsitetitle, $theme_fsitetitlegoogle ) ?>;
					  font-size: <?php echo esc_html( $theme_fsitetitlesize ) ?>; font-weight: <?php echo esc_html( $theme_fsitetitleweight ) ?>; }

#access ul li a 	{ font-family: <?php echo cryout_font_select( $theme_fmenu, $theme_fmenugoogle ) ?>;
					  font-size: <?php echo esc_html( $theme_fmenusize ) ?>; font-weight: <?php echo esc_html( $theme_fmenuweight ) ?>; }

.widget-title 		{ font-family: <?php echo cryout_font_select( $theme_fwtitle, $theme_fwtitlegoogle ) ?>;
					  font-size: <?php echo esc_html( $theme_fwtitlesize ) ?>; font-weight: <?php echo esc_html( $theme_fwtitleweight ) ?>; }
.widget-container 	{ font-family: <?php echo cryout_font_select( $theme_fwcontent, $theme_fwcontentgoogle ) ?>;
				      font-size: <?php echo esc_html( $theme_fwcontentsize ) ?>; font-weight: <?php echo esc_html( $theme_fwcontentweight ) ?>; }
.entry-title, .page-title
					{ font-family: <?php echo cryout_font_select( $theme_ftitles, $theme_ftitlesgoogle ) ?>;
					  font-size: <?php echo esc_html( $theme_ftitlessize ) ?>; font-weight: <?php echo esc_html( $theme_ftitlesweight ) ?>; }
.entry-meta > span
...
/*.post-thumbnail-container*/ .entry-meta > span { font-size: <?php echo esc_html( $theme_metatitlessize ) ?>; }

/* header titles */
.single .entry-title,
#header-page-title .entry-title
					{ font-family: <?php echo cryout_font_select( $theme_fht_title, $theme_fht_titlegoogle ) ?>;
					  font-weight: <?php echo esc_html( $theme_fht_titleweight ) ?>;
					  font-size: <?php echo esc_html( $theme_fht_titlesize ) ?>; }

#header-page-title .entry-meta > span
					{ font-family: <?php echo cryout_font_select( $theme_fht_meta, $theme_fht_metagoogle ) ?>;
					  font-weight: <?php echo esc_html( $theme_fht_metaweight ) ?>;
					  font-size: <?php echo esc_html( $theme_fht_metasize ) ?>; }
...
#site-header-main, .site-header-bottom-fixed, #access ul ul,
.menu-search-animated .searchform input[type="search"], #access .menu-search-animated .searchform, #access::after,
.roseta-over-menu .header-fixed#site-header-main, .roseta-over-menu .header-fixed#site-header-main #access:after
											{ background-color: <?php echo esc_html( $theme_menubackground ) ?>; }

.roseta-over-menu .header-fixed#site-header-main #site-title a
											{ color: <?php echo esc_html( $theme_accent1 ) ?>; }

#access > div > ul > li,
#access > div > ul > li > a,
.roseta-over-menu .header-fixed#site-header-main #access > div > ul > li:not([class*='current']),
.roseta-over-menu .header-fixed#site-header-main #access > div > ul > li:not([class*='current']) > a,
.roseta-over-menu .header-fixed#site-header-main .top-section-element.widget_cryout_socials a::before,
...
.roseta-over-menu .header-fixed#site-header-main .top-section-element.widget_cryout_socials a:hover::before,
...
.roseta-over-menu .header-fixed#site-header-main #access > div > ul > li > a:hover,
.roseta-over-menu .header-fixed#site-header-main #access > div > ul > li:hover
											{ color: <?php echo esc_html( $theme_accent1 ) ?>; }
...
.roseta-over-menu .header-fixed#site-header-main #access > div > ul > li > a
...
#colophon .widget-title 				  	{ background-color: <?php echo esc_html( $theme_contentbackground ) ?>; }
...
.main p, .main ul, .main ol, .main dd, .main pre, .main hr
											{ margin-bottom: <?php echo esc_html( $theme_paragraphspace ) ?>; }
...
<?php /* TODO: double/triple check this for all cases during beta */ ?>
...
@media (max-width: 640px) {
	#header-page-title .entry-title { font-size: <?php echo absint( $theme_fht_titlesize / 1.2 ) ?>%; }
}
...
.lp-text-image + .lp-text-text				 { background-color: <?php echo esc_html( $theme_contentbackground ); ?>; }
.lp-text-image + .lp-text-text::before		 { background-color: <?php echo esc_html( $theme_accent1 ); ?>; }
...
%%scope%% p { text-indent: <?php echo esc_html( $theme_parindent ) ?>; }
